  ...
  return (
    ...
    >
      <section className="border-b border-black bg-white">
        <div className="mx-auto grid max-w-7xl gap-5 px-6 py-7 lg:grid-cols-[0.55fr_1.45fr] lg:px-8 lg:py-9">
...
function AiSubscriptionBlock({ locale }: { locale: Locale }) {
  ...
  return (
    <section className="border-y border-white/10 bg-[#101010]" id="analytics-track">
...
function RespondentBlock({ locale }: { locale: Locale }) {
  ...
  return (
    <section className="border-y border-white/10 bg-[#090909]" id="respondent-track">
