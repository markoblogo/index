  ...
  return {
    ...
    descriptionAfterLink:
      ...
      resources: {
        ...
        releaseLanguage: "English (EN)",
        releaseVersion: "Global edition v1.0",
        releaseDateLabel: "Date",
        releaseLanguageLabel: "Language",
        audienceLabel: "Audience",
        highlightsLabel: "What this guide covers",
        audience:
          "For traders, brokers, exporters, processors, analysts, investors, students, and market operators working with physical commodity flows.",
        highlights: [
