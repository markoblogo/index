...
export type TenantId = typeof PLATFORM_TENANT_ID | ReturnType<typeof getActiveTenantId>;
...
export function isProductionRuntime(context: TenantContext = getTenantContext()) {
